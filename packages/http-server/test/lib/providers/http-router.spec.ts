...
//
//     // undefined
//     router.route('GET', 'undefined', () => Promise.resolve(undefined));
//
//     // buffer
//     router.route('GET', 'buffer', () => Promise.resolve(Buffer.from([1, 2, 3])));
//
//     // stream
...
//
//     // string
//     router.route('GET', 'string', () => Promise.resolve('Hello World'));
//
//     // JSON (true, false, number, null, array, object) but without string
//     router.route('GET', 'true', () => Promise.resolve(true));
//     router.route('GET', 'false', () => Promise.resolve(false));
//     router.route('GET', 'number', () => Promise.resolve(1245));
//     router.route('GET', 'null', () => Promise.resolve(null));
//     router.route('GET', 'array', () => Promise.resolve([1, 2, 3]));
//     router.route('GET', 'object', () => Promise.resolve({ hello: 'world' }));
//
