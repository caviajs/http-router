...
describe('Validator', () => {
  ...
  describe('SchemaBoolean', () => {
    ...
    it('should return an error if the data is not a string', () => {
      ...
      const exampleErrors: ValidationError[] = [{ message: 'The value should be boolean at /', path: '' }];
      const exampleErrorsWithPath: ValidationError[] = [{ message: 'The value should be boolean at /foo.bar', path: 'foo.bar' }];
  ...
  describe('SchemaNumber', () => {
    ...
    it('should return an error if the data is not a string', () => {
      ...
      const exampleErrors: ValidationError[] = [{ message: 'The value should be number at /', path: '' }];
      const exampleErrorsWithPath: ValidationError[] = [{ message: 'The value should be number at /foo.bar', path: 'foo.bar' }];
  ...
  describe('SchemaString', () => {
    ...
    it('should return an error if the data is not a string', () => {
      ...
      const exampleErrors: ValidationError[] = [{ message: 'The value should be string at /', path: '' }];
      const exampleErrorsWithPath: ValidationError[] = [{ message: 'The value should be string at /foo.bar', path: 'foo.bar' }];
